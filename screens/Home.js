...
import { FlatList, ScrollView, SafeAreaView,Image, StatusBar, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
{/********************************** Main Body start here ****************************/} 
    return (
        <SafeAreaView style={{flex:1, backgroundColor: COLORS.black,}}>
            ...
            {/************** header **************/}
            <View style={{ height: 170, paddingTop: 10,}}>
            ...
            <ScrollView style={{marginTop: SIZES.radius,}}>
                <View style={{flex: 1,}}>
                    {/*************** Header ***************/}
                    <View style={{paddingHorizontal:SIZES.padding,flexDirection: 'row',justifyContent: 'space-between',}}>{/* header section*/}
