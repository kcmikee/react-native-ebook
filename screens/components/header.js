...
const Header = ({profile}) => {
    return (
        <View style={{flex: 1,flexDirection: 'row',paddingHorizontal:SIZES.padding,alignItem:'center'}}>
            <View style={{flex:1}}>
            ...
            <TouchableOpacity
                ...
                onPress={()=>{console.log('points')}}>
                    <View style={{flex: 1,flexDirection: 'row',justifyContent: 'center',alignItems: 'center',}}>
                        ...
                        <Text style={{marginLeft: SIZES.base,color:COLORS.white,...FONTS.body3}}>{profile.points} points</Text>
                    </View>
                </TouchableOpacity>
        </View>
    )
